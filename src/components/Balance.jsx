...
const Balance = ({ darkMode }) => {
    return(
        <div className="bg-white p-5 w-full rounded-2xl dark:bg-gray-600 dark:text-gray-300 flex-1">
            <div className="flex justify-between items-center">
                <Title>
                    Balance
                </Title>
                <FiSend className="bg-gray-500 p-2 rounded-full text-gary-300 w-8 h-8" />
            </div>
            <div>
